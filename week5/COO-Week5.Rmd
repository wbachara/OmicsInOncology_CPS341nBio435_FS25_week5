...
SuppS6 <-read_xlsx ("science.abf3066_Table_S6.xlsx", sheet="Differential Interaction Score")
print(SuppS6)
```
...
```{r}
df <- read_xlsx ("science.abf3066_Table_S6.xlsx", sheet="Differential Interaction Score")
baits <- df$Bait
preys <- df$Prey
# Print to verify"
head(baits)
...
```{r}
plot(interactionGraph, layoutType="neato")
```
